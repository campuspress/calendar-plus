<?php
/**
 * Modern widget template: This Week Events
 * 
...
<?php if ( ! empty( $events ) ) : ?>
	<ul class="cal-plus-widget-list cal-plus-widget-list--this-week">
...
<?php else : ?>
	<p class="cal-plus-widget__no-events">
		<strong><?php esc_html_e( 'There are no events for this week.', 'calendar-plus' ); ?></strong>
	</p>
<?php endif; ?>
